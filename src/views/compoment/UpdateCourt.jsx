...
const UpdateCourt = ({ court, onUpdateCourt }) => {
  ...
  return (
    <Form form={form} initialValues={court} onFinish={handleFormSubmit} layout="vertical" style={{ maxWidth: 600 }}>
      ...
      <Form.Item label="StoreID" name="storeid" rules={[{ required: true, message: 'Please input the name!' }]}>
        <Input />
      </Form.Item>
      <Form.Item label="Slot" name="slot" rules={[{ required: true, message: 'Please select a slot for court!' }]}>
        <Select>
